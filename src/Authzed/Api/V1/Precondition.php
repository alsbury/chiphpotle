...
{
    /**
     * Generated from protobuf field <code>.authzed.api.v1.Precondition.Operation operation = 1 [json_name = "operation", (.validate.rules) = {</code>
     */
    protected $operation = 0;
    /**
     * Generated from protobuf field <code>.authzed.api.v1.RelationshipFilter filter = 2 [json_name = "filter", (.validate.rules) = {</code>
     */
