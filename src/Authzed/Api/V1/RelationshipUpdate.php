...
{
    /**
     * Generated from protobuf field <code>.authzed.api.v1.RelationshipUpdate.Operation operation = 1 [json_name = "operation", (.validate.rules) = {</code>
     */
    protected $operation = 0;
    /**
     * Generated from protobuf field <code>.authzed.api.v1.Relationship relationship = 2 [json_name = "relationship", (.validate.rules) = {</code>
     */
