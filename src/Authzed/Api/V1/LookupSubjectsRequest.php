...
class LookupSubjectsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * be returned.
     *
     * Generated from protobuf field <code>string subject_object_type = 4 [json_name = "subjectObjectType", (.validate.rules) = {</code>
     */
    protected $subject_object_type = '';
    /**
     * optional_subject_relation is the optional relation for the subject.
     *
     * Generated from protobuf field <code>string optional_subject_relation = 5 [json_name = "optionalSubjectRelation", (.validate.rules) = {</code>
     */
