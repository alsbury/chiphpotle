...
{
    /**
     * Generated from protobuf field <code>string subject_type = 1 [json_name = "subjectType", (.validate.rules) = {</code>
     */
    protected $subject_type = '';
    /**
     * Generated from protobuf field <code>string optional_subject_id = 2 [json_name = "optionalSubjectId", (.validate.rules) = {</code>
     */
    protected $optional_subject_id = '';
    /**
     * Generated from protobuf field <code>.authzed.api.v1.SubjectFilter.RelationFilter optional_relation = 3 [json_name = "optionalRelation"];</code>
     */
