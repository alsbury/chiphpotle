...
class Consistency extends \Google\Protobuf\Internal\Message
{
     ...
     * minimized by having the system select the fastest snapshot available.
     *
     * Generated from protobuf field <code>bool minimize_latency = 1 [json_name = "minimizeLatency", (.validate.rules) = {</code>
     * @return bool
     */
     ...
     * be used if available or faster.
     *
     * Generated from protobuf field <code>.authzed.api.v1.ZedToken at_least_as_fresh = 2 [json_name = "atLeastAsFresh"];</code>
     ...
     * an error will be returned to the caller.
     *
     * Generated from protobuf field <code>.authzed.api.v1.ZedToken at_exact_snapshot = 3 [json_name = "atExactSnapshot"];</code>
     * @return \Authzed\Api\V1\ZedToken|null
     */
     ...
     * ZedToken.
     *
     * Generated from protobuf field <code>bool fully_consistent = 4 [json_name = "fullyConsistent", (.validate.rules) = {</code>
     * @return bool
     */
