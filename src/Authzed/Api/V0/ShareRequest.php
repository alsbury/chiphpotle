...
/**
 * Generated from protobuf message <code>authzed.api.v0.ShareRequest</code>
 */
class ShareRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $schema = '';
    /**
     * Generated from protobuf field <code>string relationships_yaml = 2 [json_name = "relationshipsYaml"];</code>
     */
    ...
    /**
     * Generated from protobuf field <code>string assertions_yaml = 4 [json_name = "assertionsYaml"];</code>
     */
